...
def main(folder, mover_pattern, cosine_pattern, output_csv):
    ...
    for label in common_labels:
        ...
        if n < 3:
            ...
            # Store the actual numeric values rather than formatted strings
            results[label] = {"Pearson": r, "t_statistic": t, "p_value": p}
    ...
    print(f"CSV table written to {output_csv}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Calculate Pearson correlation, t-statistic, and p-value for paired CSVs "
                    ...
                    "Rows in the CSV file correspond to the numeric label (e.g., 25, 50, 75, 100)."
    )
